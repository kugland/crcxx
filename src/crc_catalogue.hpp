...
namespace crcxx {
  ...
  namespace algorithms {
    ...
    /// CRC-4/G-704
    ///
    using CRC4_G704 = ::crcxx::crc_algorithm<
      /* Width   = */ 4,
      /* Poly    = */ 0x3,
      /* Init    = */ 0x0,
      /* Refin   = */ true,
    ...
    /// CRC-5/G-704
    ///
    using CRC5_G704 = ::crcxx::crc_algorithm<
      /* Width   = */ 5,
      /* Poly    = */ 0x15,
      /* Init    = */ 0x00,
      /* Refin   = */ true,
    ...
    /// CRC-6/G-704
    ///
    using CRC6_G704 = ::crcxx::crc_algorithm<
      /* Width   = */ 6,
      /* Poly    = */ 0x03,
      /* Init    = */ 0x00,
      /* Refin   = */ true,
    ...
    /// CRC-8/I-432-1
    ///
    using CRC8_I4321 = ::crcxx::crc_algorithm<
      /* Width   = */ 8,
      /* Poly    = */ 0x07,
      /* Init    = */ 0x00,
      /* Refin   = */ false,
    ...
    /// CRC-8/NRSC-5
    ///
    using CRC8_NRSC5 = ::crcxx::crc_algorithm<
      /* Width   = */ 8,
      /* Poly    = */ 0x31,
      /* Init    = */ 0xff,
      /* Refin   = */ false,
    ...
    /// CRC-8/TECH-3250
    ///
    using CRC8_TECH3250 = ::crcxx::crc_algorithm<
      /* Width   = */ 8,
      /* Poly    = */ 0x1d,
      /* Init    = */ 0xff,
      /* Refin   = */ true,
    ...
    ///
    using CRC8_AES = CRC8_TECH3250;
    
    ///
    /// CRC-8/EBU is an alias for CRC-8/TECH-3250
    ///
    using CRC8_EBU = CRC8_TECH3250;
    ...
    /// CRC-16/DDS-110
    ///
    using CRC16_DDS110 = ::crcxx::crc_algorithm<
      /* Width   = */ 16,
      /* Poly    = */ 0x8005,
      /* Init    = */ 0x800d,
      /* Refin   = */ false,
    ...
    /// CRC-16/EN-13757
    ///
    using CRC16_EN13757 = ::crcxx::crc_algorithm<
      /* Width   = */ 16,
      /* Poly    = */ 0x3d65,
      /* Init    = */ 0x0000,
      /* Refin   = */ false,
    ...
    /// CRC-16/IBM-3740
    ///
    using CRC16_IBM3740 = ::crcxx::crc_algorithm<
      /* Width   = */ 16,
      /* Poly    = */ 0x1021,
      /* Init    = */ 0xffff,
      /* Refin   = */ false,
    ...
    ///
    using CRC16_AUTOSAR = CRC16_IBM3740;
    
    ///
    /// CRC-16/CCITT-FALSE is an alias for CRC-16/IBM-3740
    ///
    using CRC16_CCITT_FALSE = CRC16_IBM3740;
    ...
    ///
    using CRC16_ISO_IEC144433_B = CRC16_IBM_SDLC;
    
    ///
    /// CRC-16/X-25 is an alias for CRC-16/IBM-SDLC
    ///
    using CRC16_X25 = CRC16_IBM_SDLC;
    
    ///
    /// CRC-B is an alias for CRC-16/IBM-SDLC
    ///
    using CRC16_B = CRC16_IBM_SDLC;
    
    ///
    /// CRC-16/ISO-IEC-14443-3-A
    ///
    using CRC16_ISO_IEC144433_A = ::crcxx::crc_algorithm<
      /* Width   = */ 16,
      /* Poly    = */ 0x1021,
      /* Init    = */ 0xc6c6,
      /* Refin   = */ true,
    ...
    ///
    using CRC16_A = CRC16_ISO_IEC144433_A;
    ...
    /// CRC-16/NRSC-5
    ///
    using CRC16_NRSC5 = ::crcxx::crc_algorithm<
      /* Width   = */ 16,
      /* Poly    = */ 0x080b,
      /* Init    = */ 0xffff,
      /* Refin   = */ true,
    ...
    ///
    using CRC16_IEC611582 = CRC16_PROFIBUS;
    ...
    /// CRC-24/OS-9
    ///
    using CRC24_OS9 = ::crcxx::crc_algorithm<
      /* Width   = */ 24,
      /* Poly    = */ 0x800063,
      /* Init    = */ 0xffffff,
      /* Refin   = */ false,
    ...
    ///
    using CRC32_V42 = CRC32_ISO_HDLC;
    ...
    /// CRC-32/JAMCRC
    ///
    using CRC32_JAM = ::crcxx::crc_algorithm<
      /* Width   = */ 32,
      /* Poly    = */ 0x04c11db7,
      /* Init    = */ 0xffffffff,
      /* Refin   = */ true,
    ...
    /// CRC-32/MPEG-2
    ///
    using CRC32_MPEG2 = ::crcxx::crc_algorithm<
      /* Width   = */ 32,
      /* Poly    = */ 0x04c11db7,
      /* Init    = */ 0xffffffff,
      /* Refin   = */ false,
    ...
    /// CRC-64/ECMA-182
    ///
    using CRC64_ECMA182 = ::crcxx::crc_algorithm<
      /* Width   = */ 64,
